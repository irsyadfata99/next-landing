  ...
  return (
    <div className="container flex h-screen">
      <div className="column-of-images flex-1">
        <Image className="absolute top-0 left-0 object-cover opacity-60" src={"/LK-4-6.jpg"} alt="menu" width={933} height={612} />
        <Image className="absolute top-0 left-0" src="/Background-Decor-LK-JK.png" alt="logo" width={933} height={612} />
        <div className="flex flex-col items-center space-y-3 mt-48 ml-44 absolute">
