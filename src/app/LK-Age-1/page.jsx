...
const ColumnOfImages = () => {
  const imagePaths = ["/CS-List.png", "/CWS-List.png", "/CRA-List.png"];

  return (
    <div className="max-w-1920 max-h-1200 relative">
      <Image className="absolute top-0 left-0 w-[1920px] h-[612px] object-cover opacity-50" src={"/LK-4-6.png"} alt="menu" width={933} height={612} />
      ...
      <div className="text-black flex flex-col text-center justify-center">
        ...
        <div className="grid grid-cols-2 gap-4 mt-28 ml-44 z-20">
          ...
          <div>
            ...
            <Image src="/lk-46-button.png" alt="menu" width={277} height={277} />
          </div>
        </div>
      </div>
    </div>
